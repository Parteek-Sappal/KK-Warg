...
public partial class facultydetail : System.Web.UI.Page
{
    ...
    private void binddata()
    {
        ...
        string sql = "select afm.*,fdesignation.designation as designationname from Addfacultymaster afm inner join Facultydesignation fdesignation on fdesignation.fdid=afm.Designation where afm.status=1 and afm.facultyid=@facultyid order by afm.displayorder";    
