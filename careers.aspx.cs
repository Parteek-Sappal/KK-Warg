...
public partial class careers : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        parameters.Clear();
        clsm.repeaterDatashow_Parameter(rptjob, "select jobtitle,min_expyear,max_expyear,department,JobClosing_date from postedjobs where status=1 and JobClosing_date>getdate() order by displayorder", parameters);
    }
}