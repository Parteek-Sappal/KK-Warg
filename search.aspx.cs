...
public partial class search : System.Web.UI.Page
{
    ...
    public DataTable GetDataTable()
    {
        ...
        Parameters.Clear();
        strqry = "";
        strqry = "select distinct facultyid as pageid,fname as stitle, Designation as Designation, smalldesc as ldesc, pageurl='facultydetail.aspx?mpgid=60&pgidtrail=60&facultyid='+convert(varchar,facultyid) from Addfacultymaster where status=1";
