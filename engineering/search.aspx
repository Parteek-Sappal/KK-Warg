<%@ Page Title="" Language="C#" MasterPageFile="~/engineering/layouts/inner.master" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="search" %>
        ...
        <div class="search_result">
            ...
            <ul>
                <asp:Repeater ID="rptrsearch" runat="server" OnItemDataBound="rptrsearch_ItemDataBound">
                    <ItemTemplate>
                        <li><a title="Click Here" href="/engineering/<%#Eval("pageurl")%>">
                            <%#Eval("stitle")%></a>
