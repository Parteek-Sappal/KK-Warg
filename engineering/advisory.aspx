<%@ Page Title="" Language="C#" MasterPageFile="~/engineering/layouts/inner.master" AutoEventWireup="true" CodeFile="advisory.aspx.cs" Inherits="engineering_advisory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<section class="top-section bord-of-directors">
	<div class="container">
		<div class="row">
        <asp:Repeater ID="rptadvisory" runat="server">
        <ItemTemplate>
