...
public partial class engineering_usercontrols_breadcrumbs : System.Web.UI.UserControl
{
    ...
    protected void rptBread_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            else
            {
                ...
                {
                    ancher.HRef = "~/engineering/" + lblrewrite.Text.Trim();
                }
                else
                {
                    ancher.HRef = "~/engineering/" + lblpageurl.Text;
                }
            }
