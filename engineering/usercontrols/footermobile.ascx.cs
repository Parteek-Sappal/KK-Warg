...
public partial class engineering_usercontrols_footermobile : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            parameters.Clear();
            clsm.repeaterDatashow_Parameter(rptmobilemenu, "Select Pageid,PageUrl,Parentid,target,linkname,rewriteurl,megamenu,dynamicurlrewrte from PageMaster with(nolock) where PageStatus=1 and Parentid=0 and  linkposition like'%Mobile%'  and collageid=1 order by displayorder", parameters);                
        }
    }
