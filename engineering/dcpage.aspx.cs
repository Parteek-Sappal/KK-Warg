...
public partial class dcpage : System.Web.UI.Page
{
    ...
    private void ShowData()
    {
        ...
        ds1 = clsm.senddataset_Parameter("select PageName,pagemeta,PageMetaDesc,PageTitle,UploadBanner,pagename,PageDescription,smalldesc,megamenu from PageMasterdept where pagestatus=1 and Pageid=@Pageid order by displayorder", parameters);
