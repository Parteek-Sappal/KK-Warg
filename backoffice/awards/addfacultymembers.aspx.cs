    ...
    protected void btnsubmit_Click(object sender, System.EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                {
                    Status.Checked = true;
                    clsm.MasterSave(this, fid.Parent, 4, mainclass.Mode.modeAdd, "FacultymemberSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                ...
                {
                    clsm.MasterSave(this, fid.Parent, 4, mainclass.Mode.modeModify, "FacultymemberSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    clsm.ClearallPanel(this,fid.Parent);
                    gridshow();
                    trsuccess.Visible = true;
