...
public partial class backoffice_department_dept_placements : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        {
            collageid.Text = Conversion.Val(Request.QueryString["depbtid"]).ToString();
            Parameters.Clear();
            ...
            Parameters.Clear();
            Parameters.Add("@collageid", double.Parse(Request.QueryString["depbtid"]));
            ...
            if ((checkfeature.Checked == true))
            {
                ...
                if (Conversion.Val(drpdept.SelectedValue) != 0)
                {
                    ...
                    else
                    {
                        ...
                        clsm.ExecuteQry("update  map_institiute_testimonials  set  displayorder=" + txtdisplayorder.Text + " where collageid=" + (Conversion.Val(Request.QueryString["depbtid"])) + " and testimonialid=" + Conversion.Val(lbltestimonialid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + " ");
