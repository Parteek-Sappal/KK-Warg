<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    Theme="backtheme" AutoEventWireup="true" CodeFile="dept-placements.aspx.cs"
    Inherits="backoffice_department_dept_placements"  %>
                    ...
                    <table id="TABLE2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                        <tr>
                            ...
                            <td width="70%" align="right">
                                <a href="/backoffice/department/viewdepartment.aspx" style="color: White"><b>Back To Departments</b></a>
                                &nbsp;
                            </td>
                        </tr>
                    </table>
