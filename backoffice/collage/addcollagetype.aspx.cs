...
public partial class backoffice_collage_addcollagetype : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((Page.IsPostBack == false))
        {
            if ((Conversion.Val(Request.QueryString["ctid"]) != 0))
            {
                ...
                clsm.MoveRecord_Parameter(this, ctid.Parent, "select * from collagetype where ctid=@ctid", Parameters);
        ...
        try
        {
            ...
            if ((Page.IsValid == true))
            {
                ...
                if ((Conversion.Val(ctid.Text) == 0))
                {
                    ...
                    CKeditor1.ReadOnly = true;
                    CKeditor2.ReadOnly = true;
                    object var = clsm.MasterSave(this, ctid.Parent, 18, mainclass.Mode.modeAdd, "collagetypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    CKeditor1.ReadOnly = false;
                    CKeditor2.ReadOnly = false;
                    if ((File1.PostedFile.FileName != ""))
                    {
                        ...
                        StrFileName = Convert.ToString(clsm.SendValue_Parameter("Select uploadbanner from collagetype where ctid=@ctid ", Parameters));
                ...
                else
                {
                    ...
                    CKeditor1.ReadOnly = true;
                    CKeditor2.ReadOnly = true;
                    object var = clsm.MasterSave(this, ctid.Parent, 18, mainclass.Mode.modeModify, "collagetypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    CKeditor1.ReadOnly = false;
                    CKeditor2.ReadOnly = false;
                    if ((File1.PostedFile.FileName != ""))
                    {
                        ...
                        objcon.Open();
                        SqlCommand objcmd = new SqlCommand(("update collagetype set uploadbanner=@uploadbanner where ctid="
                    ...
                    clsm.ClearallPanel(this, ctid.Parent);
                    Response.Redirect("viewcollagetype.aspx?edit=edit");
                }
