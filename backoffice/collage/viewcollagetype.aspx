<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="viewcollagetype.aspx.cs" Inherits="backoffice_collage_viewcollagetype" %>
            ...
            <td align="center" colspan="2" height="10">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="Horizontal"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Collage Type" ItemStyle-Width="15%">
