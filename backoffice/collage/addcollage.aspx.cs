...
public partial class backoffice_collage_addcollage : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            linkpositionstatus.EnableViewState = false;
            if(Convert.ToInt32(Convert.ToString( clsm.MasterSave(this, collageid.Parent, 37, mainclass.Mode.modeCheckDuplicate, "collage_MasterSP", Server.HtmlDecode(Session["UserId"].ToString())))) > 0 )
            {
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
            ...
            if(Conversion.Val(collageid.Text) == 0)
            {
                ...
                var var = clsm.MasterSave(this, collageid.Parent, 37, mainclass.Mode.modeAdd, "collage_MasterSP", Server.HtmlDecode(Session["UserId"].ToString()));
            ...
            else
            {
                ...
                var var = clsm.MasterSave(this, collageid.Parent, 37, mainclass.Mode.modeModify, "collage_MasterSP", Server.HtmlDecode(Session["UserId"].ToString()));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
                CKeditor4.ReadOnly = false;
