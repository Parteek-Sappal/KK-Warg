...
public partial class backoffice_collage_collage_happenings : System.Web.UI.Page
{
    ...
    void fillgrid()
    {
        string strsql;
        Parameters.Clear();
        strsql = "select distinct a.*,b.ntype from map_happening_campus  mc left join   Events a on mc.eventsid=a.Eventsid left join newstype b on a.ntypeid=b.ntypeid left join collage_master cm on mc.campusid=cm.campusid    where 1=1  ";
