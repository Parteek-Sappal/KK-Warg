<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    ValidateRequest="false" Theme="backtheme" AutoEventWireup="true" CodeFile="addcollage.aspx.cs"
    Inherits="backoffice_collage_addcollage" %>
        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td valign="top" width="15%" align="right">
                    College Type <span class="star">*</span>: &nbsp;
                </td>
                <td width="85%">
                    <asp:DropDownList ID="ctid" runat="server" Width="359px">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="ctid"
            ...
            <tr>
                ...
                <td width="85%">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="campusid"
                    Display="Dynamic" ErrorMessage="Required" InitialValue="0"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr style="display:none">
                ...
                <td align="left" valign="top">
                    <asp:CheckBoxList ID="linkpositionstatus" runat="server" RepeatDirection="Horizontal"
                        Width="50%">
                        <asp:ListItem>Left 1</asp:ListItem>
                        <asp:ListItem>Left 2</asp:ListItem>
                        <asp:ListItem>Left 3</asp:ListItem>
                        <asp:ListItem>Left 4</asp:ListItem>
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" style="width: 85%">
                    ...
                    <asp:TextBox ID="campaddress" runat="server" Visible="False" CssClass="box" Width="359px"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left" style="width: 85%">
                    ...
                    <asp:TextBox ID="factfigure" runat="server" Visible="False" CssClass="box" Width="359px"></asp:TextBox>
                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="campaddress"
                    Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator>--%>
                    <%--<asp:RegularExpressionValidator ID="regexpDesc" runat="server" ErrorMessage="Maximum of 500 characters allowed"
                    ControlToValidate="campaddress" Display="Dynamic" ValidationExpression=".{0,500}" />--%>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:LinkButton ID="LinkButton4" runat="server" CssClass="toptxt" Visible="false"
                        OnClick="LinkButton4_Click">Remove Image</asp:LinkButton>
