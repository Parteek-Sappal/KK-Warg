    ...
    public void map_cat_product()
    {
        foreach (DataListItem row1 in dl_sgroup.Items)
        {
            ...
            if ((checkfeature.Checked == true))
            {
                ...
                //                + (Conversion.Val(lbltestimonialid.Text) + ""))))) == false))
                //{
                //    clsm.ExecuteQry(("insert into map_institiute_testimonials (collageid,testimonialid) values("
                ...
                if (Conversion.Val(drpdept.SelectedValue) != 0)
                {
                    ...
                    if (clsm.Checking("select mtestimonialid from map_institute_recruiter where collageid="
                                    ...
                                    + (Conversion.Val(drpdept.SelectedValue) + "")))))) == false)
                    {
                        ...
                        clsm.ExecuteQry("insert into map_institute_recruiter (collageid,imgid,deptid,displayorder) values("
                                        + (Conversion.Val(Request.QueryString["clid"]) + (","
                                        + (Conversion.Val(lbltestimonialid.Text) + (","
                    ...
                    else
                    {
                        ...
                        clsm.ExecuteQry("update  map_institute_recruiter  set  displayorder=" + txtdisplayorder.Text + " where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and imgid=" + Conversion.Val(lbltestimonialid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + " ");

                    }
                }
                else
                {
                    if (clsm.Checking("select mrecid from map_institute_recruiter where collageid="
                                   + Conversion.Val(Request.QueryString["clid"]) + " and imgid="
                                   + Conversion.Val(lbltestimonialid.Text) + " and deptid="
                                   + Conversion.Val(drpdept.SelectedValue) + "") == false)
                    {
                ...
                {
                    clsm.ExecuteQry("update  map_institute_recruiter  set  showonhome=1 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and imgid=" + Conversion.Val(lbltestimonialid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                }
                else
                {
                    clsm.ExecuteQry("update  map_institute_recruiter  set  showonhome=0 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and imgid=" + Conversion.Val(lbltestimonialid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                }
            ...
            else
            {
                ...
                clsm.ExecuteQry("delete from  map_institute_recruiter where  collageid=" + Conversion.Val(Request.QueryString["clid"]) + " and imgid=" + Conversion.Val(lbltestimonialid.Text) + "  and deptid=" + Conversion.Val(drpdept.SelectedValue) + "  ");
