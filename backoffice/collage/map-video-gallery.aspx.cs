        ...
        foreach (DataListItem row1 in dl_sgroup.Items)
        {
            ...
            if ((checkfeature.Checked == true))
            {
                ...
                if (Conversion.Val(drpdept.SelectedValue) != 0)
                {
                    ...
                    if (clsm.Checking("select mtypeid from map_video_gallery where collageid="
                                    ...
                                    + (Conversion.Val(drpdept.SelectedValue) + "")))))) == false)
                    {
                        ...
                        clsm.ExecuteQry("insert into map_video_gallery (collageid,typeid,deptid,displayorder) values("
                    ...
                    else
                    {
                        ...
                        clsm.ExecuteQry("update  map_video_gallery  set  displayorder=" + txtdisplayorder.Text + " where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and typeid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                ...
                {
                    clsm.ExecuteQry("update  map_video_gallery  set  showonhome=1 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and typeid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                }
                else
                {
                    clsm.ExecuteQry("update  map_video_gallery  set  showonhome=0 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and typeid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                }
            ...
            else
            {
                ...
                clsm.ExecuteQry("delete from  map_video_gallery where  collageid=" + Conversion.Val(Request.QueryString["clid"]) + " and typeid=" + Conversion.Val(lblEventsid.Text) + "  and deptid=" + Conversion.Val(drpdept.SelectedValue) + "  ");
