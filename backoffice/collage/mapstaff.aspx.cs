        ...
        foreach (DataListItem row1 in dl_sgroup.Items)
        {
            ...
            if ((checkfeature.Checked == true))
            {
                ...
                if (Conversion.Val(drpdept.SelectedValue) != 0)
                {
                    ...
                    if (clsm.Checking("select mfid from map_institute_department_staff where collageid="
                                    ...
                                    + (Conversion.Val(drpdept.SelectedValue) + "")))))) == false)
                    {
                        ...
                        clsm.ExecuteQry("insert into map_institute_department_staff (collageid,staffid,deptid,displayorder) values("
                    ...
                    else
                    {
                        ...
                        clsm.ExecuteQry("update  map_institute_department_staff  set  displayorder=" + txtdisplayorder.Text + " where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and staffid=" + Conversion.Val(lblfacultyid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                ...
                {
                    clsm.ExecuteQry("update  map_institute_department_staff  set  showonhome=1 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and staffid=" + Conversion.Val(lblfacultyid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                }
                else
                {
                    clsm.ExecuteQry("update  map_institute_department_staff  set  showonhome=0 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and staffid=" + Conversion.Val(lblfacultyid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "");
                }
            ...
            else
            {
                ...
                clsm.ExecuteQry("delete from  map_institute_department_staff where  collageid=" + Conversion.Val(Request.QueryString["clid"]) + " and staffid=" + Conversion.Val(lblfacultyid.Text) + "  and deptid=" + Conversion.Val(drpdept.SelectedValue) + "  ");
