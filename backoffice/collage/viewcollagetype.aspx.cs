...
public partial class backoffice_collage_viewcollagetype : System.Web.UI.Page
{
    ...
    {
        Parameters.Clear();
        Clsm.GridviewData_Parameter(GridView1, "select * from collagetype order by displayorder", Parameters);
        if ((GridView1.Rows.Count == 0))
        {
            trnotice.Visible = true;
            lblnotice.Text = "Collage Type (s) not found.";
        }
    ...
    protected void GridView1_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(("addcollagetype.aspx?ctid=" + Conversion.Val(e.CommandArgument)));
        ...
        if ((e.CommandName == "lnkstatus"))
        {
            ...
            if ((txtstatus.Text == "False"))
            {
                ...
                Clsm.ExecuteQry_Parameter("update collagetype set status=1 where ctid=@ctid", Parameters);
            }
            else if ((txtstatus.Text == "True"))
            {
                Parameters.Clear();
                Parameters.Add("@ctid", Conversion.Val(e.CommandArgument));
                Clsm.ExecuteQry_Parameter("update collagetype set status=0 where ctid=@ctid", Parameters);
            }
