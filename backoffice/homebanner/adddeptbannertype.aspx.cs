        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                if (Conversion.Val(btypeid.Text) == 0)
                {
                    ...
                    clsm.MasterSave(this, btypeid.Parent, 6, mainclass.Mode.modeAdd, "depthomebannertypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                ...
                {
                    clsm.MasterSave(this, btypeid.Parent, 6, mainclass.Mode.modeModify, "depthomebannertypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
