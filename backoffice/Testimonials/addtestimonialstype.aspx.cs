    ...
    protected void btnsubmit_Click(object sender, System.EventArgs e) 
    {
        if(Page.IsValid)
        {
            try 
            {
                ...
                if (Convert.ToInt32(Clsm.MasterSave(this, Tesid.Parent, 6, mainclass.Mode.modeCheckDuplicate, "Testimonials_TypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])))) > 0)
                {
                    trnotice.Visible = true;
                ...
                if ((Conversion.Val(Tesid.Text) == 0))
                {
                    ...
                    Status.Checked = true;
                    object var = Clsm.MasterSave(this, Tesid.Parent, 6, mainclass.Mode.modeAdd, "Testimonials_TypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    if ((File1.PostedFile.FileName != "")) {
                    ...
                    object var = Clsm.MasterSave(this, Tesid.Parent, 6, mainclass.Mode.modeModify, "Testimonials_TypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    if ((File1.PostedFile.FileName != "")) {
