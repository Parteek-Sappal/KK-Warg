                         ...
                         <tr>
                          <td align="right">
                            ...
                            <td align="left">
                                ...
                                AutoPostBack="true"     onselectedindexchanged="campusid_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                           <td align="right">
                                College:
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                      ...
                      <%--<asp:TemplateField HeaderText="School" Visible="false">
                        ...
                        <asp:TemplateField HeaderText="Show Home" Visible="true">
                            <HeaderStyle HorizontalAlign="Center" Width="5%" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                         ...
                         <asp:TemplateField HeaderText="Map Semester"  Visible="false">
                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                          <a class="toptxtsem" href='addcoursesemester.aspx?courseid=<%#(Eval("courseid"))%>'>
                        ...
                        <asp:TemplateField HeaderText="Delete" Visible="false">
                            ...
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("courseid")) %>'
