...
public partial class backoffice_Course_vewaddcourse : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if ((Page.IsPostBack == false))
        {
            ...
            Parameters.Clear();
            clsm.Fillcombo_Parameter("select distinct c.campus_name,c.campusid from  collage_master cm inner join  campus c  on c.campusid=cm.campusid", Parameters, campusid);
            Parameters.Clear();
    ...
    public void bindcollage()
    {
        ...
        clsm.Fillcombo_Parameter("select distinct collagename,collageid from collage_master where status=1 and campusid=@campusid ", Parameters, collageid);
    }
