        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="eligiblitydetails" runat="server" Visible="False" Width="122px"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr >
                ...
                <td align="left">
                    ...
                    <asp:TextBox ID="CareerPath" runat="server" Visible="false" Width="350px"></asp:TextBox>
                </td>
            </tr>
            <tr style="display: none;">
                <td valign="top" align="right">
            ...
            <tr style="display: none;" >
                ...
                <td>
                    ...
                    <asp:TextBox ID="scholarships" Visible="false" runat="server" Width="350px"></asp:TextBox>
                </td>
            </tr>
            <tr style="display: none">
                <td valign="top" align="right">
