...
public partial class backoffice_masters_courselevelseo : System.Web.UI.Page
{
    ...
    protected void griddata()
    {
        ...
        strq2 = "select ms.*,cm.collagename,clm.levelname from CourseLevel_Master_Seo ms inner join collage_master cm on ms.collageid=cm.collageid left join CourseLevel_Master clm on ms.levelid=clm.levelid  where 1=1 and  cm.status=1 ";
