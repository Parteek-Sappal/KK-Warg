...
public partial class backoffice_media_upload_image : System.Web.UI.Page
{
    ...
    private void FillImage()
    {
        ...
        DataSet ds = clsm.senddataset_Parameter("select photoid,phototitle,uploadphoto,phototitle,displayorder  from mediaAlbumPhoto where Albumid=@Albumid", Parameters);
    ...
    protected void AjaxFileUpload1_UploadComplete(object sender, AjaxControlToolkit.AjaxFileUploadEventArgs e)
    {
        ...
        try
        {
            ...
            objcon.Open();
            SqlCommand objcmd = new SqlCommand("mediaAlbumPhotoSP", objcon);
            objcmd.CommandType = CommandType.StoredProcedure;
            objcmd.Parameters.AddWithValue("@AlbumId", Conversion.Val(Request.QueryString["eventsid"]));
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            foreach (DataListItem item in dtlview.Items)
            {
                ...
                clsm.ExecuteQry_Parameter("update mediaAlbumPhoto set phototitle=@phototitle,displayorder=@displayorder where photoid=@photoid", Parameters);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (DataListItem item in dtlview.Items)
            {
                ...
                {
                    Parameters.Add("@photoid", lblphotoid.Text);
                    clsm.ExecuteQry_Parameter("delete from mediaAlbumPhoto where photoid=@photoid", Parameters);
