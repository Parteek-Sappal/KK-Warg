...
public partial class backoffice_media_media_section : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            parameters.Clear();
            clsm.Fillcombo_Parameter(" select typename,id from cattype where status=1  order by  displayorder", parameters, cattype);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Eventsid.Text == "")
            {
                ...
                CKeditor1.ReadOnly = true;
                CKeditor2.ReadOnly = true;
                string var = clsm.MasterSave(this, Eventsid.Parent, 31, mainclass.Mode.modeAdd, "EventsSP", Session["UserId"].ToString());
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
            ...
            else
            {
                ...
                string var = clsm.MasterSave(this, Eventsid.Parent, 31, mainclass.Mode.modeModify, "EventsSP", Session["UserId"].ToString());
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
