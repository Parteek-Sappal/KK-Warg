    ...
    protected void btnsubmit_Click(object sender, System.EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                //if (clsm.Checking("select facultyid from Addfacultymaster where displayorder=" + Conversion.Val(displayorder.Text) + "") == true)
                //{
                ...
                //    else if (Conversion.Val(ViewState["displayorder"]) != Conversion.Val(displayorder.Text))
                //    {
                //        string strsql = "select displayorder,facultyid from Addfacultymaster where displayorder>=" + Conversion.Val(strmin) + " and displayorder<=" + Conversion.Val(strmax) + "  and facultyid <>" + Conversion.Val(Request.QueryString["fid"]) + "order by displayorder";
                ...
                //                if (Conversion.Val(ViewState["displayorder"]) < Conversion.Val(displayorder.Text))
                //                {
                //                    clsm.ExecuteQry("update Addfacultymaster set displayorder=" + Conversion.Val(ds.Tables[0].Rows[i]["displayorder"]) + "-1 where facultyid=" + Conversion.Val(ds.Tables[0].Rows[i]["facultyid"]) + "");

                //                }
                //                else
                //                {
                //                    clsm.ExecuteQry("update Addfacultymaster set displayorder=" + Conversion.Val(Convert.ToString(ds.Tables[0].Rows[i]["displayorder"])) + "+1  where facultyid=" + Conversion.Val(Convert.ToString(ds.Tables[0].Rows[i]["facultyid"])) + "");
