        ...
        if(Page.IsValid)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(JobId.Text))
                {
                    ...
                    CKeditor3.ReadOnly = true;
                    CKeditor4.ReadOnly = true;
                    clsm.MasterSave(this, Label1.Parent, 27, mainclass.Mode.modeAdd, "PostedJobsSP", Convert.ToString(Session["UserId"]));
                    CKeditor1.ReadOnly = false;
                    CKeditor2.ReadOnly = false;
                    CKeditor3.ReadOnly = false;
                    CKeditor4.ReadOnly = false;
                ...
                else
                {
                    ...
                    CKeditor3.ReadOnly = true;
                    CKeditor4.ReadOnly = true;
                    clsm.MasterSave(this, Label1.Parent, 27, mainclass.Mode.modeModify, "PostedJobsSP", Convert.ToString(Session["UserId"]));
                    CKeditor1.ReadOnly = false;
                    CKeditor2.ReadOnly = false;
                    CKeditor3.ReadOnly = false;
                    CKeditor4.ReadOnly = false;
